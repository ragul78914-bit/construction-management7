    ...
    <div>
          ...
          <div className="larkon-stats-grid">
            <div className="card stat-card-larkon">
               ...
               <div className="stat-footer">
                 ...
                 <Link to="/admin/sites" className="view-more">View All</Link>
               </div>
            </div>
            ...
            <div className="card stat-card-larkon">
               ...
               <div className="stat-footer">
                 ...
                 <Link to="/admin/workers" className="view-more">View All</Link>
               </div>
            </div>
            ...
            <div className="card stat-card-larkon">
               ...
               <div className="stat-footer">
                 ...
                 <Link to="/admin/supervisors" className="view-more">View All</Link>
               </div>
            </div>
            ...
            <div className="card stat-card-larkon">
               ...
               <div className="stat-footer">
                 ...
                 <Link to="/admin/materials" className="view-more">View All</Link>
               </div>
            </div>
          </div>
      ...
      <div className="card mt-4 p-4" style={{ borderRadius: 16 }}>
        <div className="flex justify-between items-center mb-4">
          ...
          <Link to="/admin/sites" className="btn btn-outline" style={{ fontSize: '0.8rem', padding: '0.4rem 1rem' }}>View All</Link>
        </div>
            ...
            <tbody>
              {sites.slice(0, 5).map(site => (
                <tr key={site.id}>
                  ...
                  <td>
                    <Link to={`/admin/sites/${site.id}`} style={{ color: 'var(--primary-color)', fontSize: '0.85rem', fontWeight: 600 }}>Manage</Link>
                  </td>
                </tr>
              ))}
              {sites.length === 0 && (
