          ...
          <div className="larkon-stats-grid">
            <div className="card stat-card-larkon">
               ...
               <div className="stat-footer">
                 ...
                 <Link href="/supervisor/site-overview" className="view-more">View All</Link>
               </div>
            </div>
            ...
            <div className="card stat-card-larkon">
               ...
               <div className="stat-footer">
                 ...
                 <Link href="/supervisor/workers" className="view-more">View All</Link>
               </div>
            </div>
            ...
            <div className="card stat-card-larkon">
               ...
               <div className="stat-footer">
                 ...
                 <Link href="/supervisor/materials" className="view-more">View All</Link>
               </div>
            </div>
