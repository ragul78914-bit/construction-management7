...
export function AdminSiteDetail() {
  ...
  const [newWorkerForm, setNewWorkerForm] = useState({
    name: '', role: 'Worker', trade: '', phone: '', email: '', password: '', assignedSite: id, status: 'Active', documents: [], dailyWage: 0
  });
  ...
  return (
    <div>
      <div className="mb-3">
        <Link href="/admin/sites" className="flex items-center text-muted" style={{ display: 'inline-flex', gap: '0.5rem' }}>
